...
class Database { 
     ...
     */
    private $db_host = 'phpchessgame.db.9045956.hostedresource.com';// Database Host
    private $db_user = 'phpchessgame';// Username
    private $db_pass = 'Wm310887!';// Password
    private $db_name = 'phpchessgame';// Database
    /*
     * End edit
     */
